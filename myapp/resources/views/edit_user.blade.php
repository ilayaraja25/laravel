...
<body>
    ...
    <form method="post" action="{{ url('updates/'.$staff->id) }}">
    <table cellspacing="20">
<tr>
<td>Name</td>
<td><input type="text" name="Name" placeholder="Enter your name"  value="{{$staff->Name}}"></td>
</tr>

<tr>
<td>
Address</td>
<td><textarea name="Address" rows="5" cols="40"placeholder="Enter your Address" value="{{$staff->Address}}"></textarea></td>
</tr>
